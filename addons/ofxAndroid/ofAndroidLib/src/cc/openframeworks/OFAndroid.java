...
public class OFAndroid {
    ...
    public static void setupMagnetometer(){
        if(magnetometer==null)
            magnetometer = new OFAndroidMagnetometer((SensorManager)ofActivity.getSystemService(Context.SENSOR_SERVICE));
    }

    public static void setupGyroscope(){
        if(gyroscope==null)
            gyroscope = new OFAndroidGyroscope((SensorManager)ofActivity.getSystemService(Context.SENSOR_SERVICE));
    }
    
    public static void setupDeviceOrientation(){
        if(deviceOrientation==null)
            deviceOrientation = new OFAndroidDeviceOrientation((SensorManager)ofActivity.getSystemService(Context.SENSOR_SERVICE));
    }
    ...
    private static OFAndroidMagnetometer magnetometer;
    private static OFAndroidGyroscope gyroscope;
    private static OFAndroidDeviceOrientation deviceOrientation;
